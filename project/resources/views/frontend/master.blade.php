...
<body class="js">
					...
					<div class="col-lg-8 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								<li class="sm"><i class="ti-user"></i> <a href="{{ url('login') }}">My account</a></li>
			...
			<div class="inner-top">
				<div class="row">
					<div class="col-lg-8 offset-lg-2 col-12">
						...
						<div class="inner">
							<h4>Newsletter</h4>
							<p> Subscribe to our newsletter and get <span>Updates</span> of our all products and news.</p>
	...
	<script>
		$('.bannarowl-carousel').owlCarousel({
			loop:true,
			margin:10,
			nav:true,
			dots:true,
