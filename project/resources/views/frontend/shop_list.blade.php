						...
						<div class="shop-sidebar">
								...
								@csrf
									<div class="single-widget range">
										...
										<input type="number" class="input" name="start" placeholder="Enter starting Price"><br><br>
										<input type="number" class="input" name="end" placeholder="Ending Price">
										<br><br>
                        ...
                        @foreach($product as $pro)
                            <li class="item ">
                                ...
                                <div class="product-shop"><br>
                                    ...
                                    <ul>
                                        <li class="my"> <a href="{{ route('AddWishlist', $pro->id) }}"> <i class="fa fa-heart"></i><span> Add to Wishlist</span> </a> </li>
                                        <li class="my"> <a href="{{ route('AddToCompare', $pro->id) }}"> <i class="fa fa-signal"></i><span> Add to Compare</span> </a> </li>
                                    </ul>
                                    </div>
                                </div>
                            </li>
